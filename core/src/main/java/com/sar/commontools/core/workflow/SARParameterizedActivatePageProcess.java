...
@Component(service = WorkflowProcess.class, property = { "process.label=SAR Parameterized Activate Page Process" })
public class SARParameterizedActivatePageProcess extends ActivatePageProcess {
